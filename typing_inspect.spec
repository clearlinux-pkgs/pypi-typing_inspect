...
%prep
%setup -q -n typing_inspect-0.6.0
cd %{_builddir}/typing_inspect-0.6.0
...
cp %{_builddir}/typing_inspect-0.6.0/LICENSE %{buildroot}/usr/share/package-licenses/typing_inspect/6d59abdf2e69c2e84d4f92cf54ac844fb1f16d8b
